...
static const u16 sHoennToNationalOrder[HOENN_DEX_COUNT - 1] =
{
    ...
    HOENN_TO_NATIONAL(EXILED_MACHOP),
    HOENN_TO_NATIONAL(EXILED_MACHOKE),
    HOENN_TO_NATIONAL(EXILED_MACHAMP),
    HOENN_TO_NATIONAL(EXILED_WHISMUR),
    HOENN_TO_NATIONAL(EXILED_LOUDRED),
    HOENN_TO_NATIONAL(EXILED_EXPLOUD),
    HOENN_TO_NATIONAL(EXILED_SANDILE),
    HOENN_TO_NATIONAL(EXILED_KROKOROK),
    HOENN_TO_NATIONAL(EXILED_KROOKODILE),
    HOENN_TO_NATIONAL(EXILED_CARVANHA),
    HOENN_TO_NATIONAL(EXILED_SHARPEDO),
    HOENN_TO_NATIONAL(EXILED_NUMEL),
    HOENN_TO_NATIONAL(EXILED_CAMERUPT),
    HOENN_TO_NATIONAL(EXILED_PACHIRISU),
    HOENN_TO_NATIONAL(EXILED_SURSKIT),
    HOENN_TO_NATIONAL(EXILED_MASQUERAIN),
    HOENN_TO_NATIONAL(EXILED_DRUDDIGON),
    HOENN_TO_NATIONAL(EXILED_WIMPOD),
    HOENN_TO_NATIONAL(EXILED_GOLISOPOD),
    HOENN_TO_NATIONAL(EXILED_SPHEAL),
    HOENN_TO_NATIONAL(EXILED_SEALEO),
    HOENN_TO_NATIONAL(EXILED_WALREIN),
    HOENN_TO_NATIONAL(EXILED_DODUO),
    HOENN_TO_NATIONAL(EXILED_DODRIO),
    HOENN_TO_NATIONAL(EXILED_BARBOACH),
    HOENN_TO_NATIONAL(EXILED_WHISCASH),
    HOENN_TO_NATIONAL(EXILED_COTTONEE),
    HOENN_TO_NATIONAL(EXILED_WHIMSICOTT),
    HOENN_TO_NATIONAL(EXILED_CATERPIE),
    HOENN_TO_NATIONAL(EXILED_METAPOD),
    HOENN_TO_NATIONAL(EXILED_BUTTERFREE),
    HOENN_TO_NATIONAL(EXILED_GRUBBIN),
    HOENN_TO_NATIONAL(EXILED_CHARJABUG),
    HOENN_TO_NATIONAL(EXILED_VIKAVOLT),
    HOENN_TO_NATIONAL(EXILED_NIDORAN_F),
    HOENN_TO_NATIONAL(EXILED_NIDORINA),
    HOENN_TO_NATIONAL(EXILED_NIDOQUEEN),
    HOENN_TO_NATIONAL(EXILED_ABRA),
    HOENN_TO_NATIONAL(EXILED_KADABRA),
    HOENN_TO_NATIONAL(EXILED_ALAKAZAM),
    HOENN_TO_NATIONAL(EXILED_SLUGMA),
    HOENN_TO_NATIONAL(EXILED_MAGCARGO),
