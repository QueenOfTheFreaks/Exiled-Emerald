...
const struct SpeciesInfo gSpeciesInfoGen9[] =
{
    ...
    [SPECIES_MAUSHOLD_FAMILY_OF_THREE] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD, EGG_GROUP_FAIRY),
        .abilities = { ABILITY_FRIEND_GUARD, ABILITY_TECHNICIAN, ABILITY_PARENTAL_BOND },
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_TINKATUFF] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 55, SPECIES_TINKATON}),
    },
    ...
    [SPECIES_TINKATON] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FAIRY),
        .abilities = { ABILITY_MOLD_BREAKER, ABILITY_OWN_TEMPO, ABILITY_SUPER_LUCK },
        .bodyColor = BODY_COLOR_PINK,
