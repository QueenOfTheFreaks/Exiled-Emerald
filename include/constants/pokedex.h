...
enum {
    ...
    NATIONAL_DEX_EXILED_MACHOP,
    NATIONAL_DEX_EXILED_MACHOKE,
    NATIONAL_DEX_EXILED_MACHAMP,
    NATIONAL_DEX_EXILED_WHISMUR,
    NATIONAL_DEX_EXILED_LOUDRED,
    NATIONAL_DEX_EXILED_EXPLOUD,
    NATIONAL_DEX_EXILED_SANDILE,
    NATIONAL_DEX_EXILED_KROKOROK,
    NATIONAL_DEX_EXILED_KROOKODILE,
    NATIONAL_DEX_EXILED_CARVANHA,
    NATIONAL_DEX_EXILED_SHARPEDO,
    NATIONAL_DEX_EXILED_NUMEL,
    NATIONAL_DEX_EXILED_CAMERUPT,
    NATIONAL_DEX_EXILED_PACHIRISU,
    NATIONAL_DEX_EXILED_SURSKIT,
    NATIONAL_DEX_EXILED_MASQUERAIN,
    NATIONAL_DEX_EXILED_DRUDDIGON,
    NATIONAL_DEX_EXILED_WIMPOD,
    NATIONAL_DEX_EXILED_GOLISOPOD,
    NATIONAL_DEX_EXILED_SPHEAL,
    NATIONAL_DEX_EXILED_SEALEO,
    NATIONAL_DEX_EXILED_WALREIN,
    NATIONAL_DEX_EXILED_DODUO,
    NATIONAL_DEX_EXILED_DODRIO,
    NATIONAL_DEX_EXILED_BARBOACH,
    NATIONAL_DEX_EXILED_WHISCASH,
    NATIONAL_DEX_EXILED_COTTONEE,
    NATIONAL_DEX_EXILED_WHIMSICOTT,
    NATIONAL_DEX_EXILED_CATERPIE,
    NATIONAL_DEX_EXILED_METAPOD,
    NATIONAL_DEX_EXILED_BUTTERFREE,
    NATIONAL_DEX_EXILED_GRUBBIN,
    NATIONAL_DEX_EXILED_CHARJABUG,
    NATIONAL_DEX_EXILED_VIKAVOLT,
    NATIONAL_DEX_EXILED_NIDORAN_F,
    NATIONAL_DEX_EXILED_NIDORINA,
    NATIONAL_DEX_EXILED_NIDOQUEEN,
    NATIONAL_DEX_EXILED_ABRA,
    NATIONAL_DEX_EXILED_KADABRA,
    NATIONAL_DEX_EXILED_ALAKAZAM,
    NATIONAL_DEX_EXILED_SLUGMA,
    NATIONAL_DEX_EXILED_MAGCARGO,
};
...
enum {
    ...
    HOENN_DEX_JIRACHI,
    HOENN_DEX_DEOXYS,
    HOENN_DEX_EXILED_MACHOP,
    HOENN_DEX_EXILED_MACHOKE,
    HOENN_DEX_EXILED_MACHAMP,
    HOENN_DEX_EXILED_WHISMUR,
    HOENN_DEX_EXILED_LOUDRED,
    HOENN_DEX_EXILED_EXPLOUD,
    HOENN_DEX_EXILED_SANDILE,
    HOENN_DEX_EXILED_KROKOROK,
    HOENN_DEX_EXILED_KROOKODILE,
    HOENN_DEX_EXILED_CARVANHA,
    HOENN_DEX_EXILED_SHARPEDO,
    HOENN_DEX_EXILED_NUMEL,
    HOENN_DEX_EXILED_CAMERUPT,
    HOENN_DEX_EXILED_PACHIRISU,
    HOENN_DEX_EXILED_SURSKIT,
    HOENN_DEX_EXILED_MASQUERAIN,
    HOENN_DEX_EXILED_DRUDDIGON,
    HOENN_DEX_EXILED_WIMPOD,
    HOENN_DEX_EXILED_GOLISOPOD,
    HOENN_DEX_EXILED_SPHEAL,
    HOENN_DEX_EXILED_SEALEO,
    HOENN_DEX_EXILED_WALREIN,
    HOENN_DEX_EXILED_DODUO,
    HOENN_DEX_EXILED_DODRIO,
    HOENN_DEX_EXILED_BARBOACH,
    HOENN_DEX_EXILED_WHISCASH,
    HOENN_DEX_EXILED_COTTONEE,
    HOENN_DEX_EXILED_WHIMSICOTT,
    HOENN_DEX_EXILED_CATERPIE,
    HOENN_DEX_EXILED_METAPOD,
    HOENN_DEX_EXILED_BUTTERFREE,
    HOENN_DEX_EXILED_GRUBBIN,
    HOENN_DEX_EXILED_CHARJABUG,
    HOENN_DEX_EXILED_VIKAVOLT,
    HOENN_DEX_EXILED_NIDORAN_F,
    HOENN_DEX_EXILED_NIDORINA,
    HOENN_DEX_EXILED_NIDOQUEEN,
    HOENN_DEX_EXILED_ABRA,
    HOENN_DEX_EXILED_KADABRA,
    HOENN_DEX_EXILED_ALAKAZAM,
    HOENN_DEX_EXILED_SLUGMA,
    HOENN_DEX_EXILED_MAGCARGO,
};

#define HOENN_DEX_COUNT (HOENN_DEX_EXILED_MAGCARGO + 1)
